...
from src.ai_vtuber.server import WebSocketServer
from src.ai_vtuber.config_manager import Config, read_yaml, validate_config
...
def parse_args():
    parser = argparse.ArgumentParser(description="AI VTuber Server")
...
def run(console_log_level: str):
    ...
    logger.info(f"AI VTuber, version v{get_version()}")
